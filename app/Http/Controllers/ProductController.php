...
class ProductController extends Controller
{
    ...
    public function findAllProducts(Request $request)
    {
        if($request->input('product')) {
            return $this->productService->findProductByName($request->input('product'), $request->input('size'));
        }
    ...
    public function findProductsByCategory(Request $request)
    {
        ...
        return $this->productService->findProductByCategory($request->q, $request->input('size'));
    }
