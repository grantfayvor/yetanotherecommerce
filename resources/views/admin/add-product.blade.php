...
<head>
    <title>Our-Town::Add Product</title>
                            ...
                            <div class="work-progres">
                                ...
                                <div class="signup-block">
                                    <form class="form-horizontal form-label-left input_mask" enctype="MULTIPART/FORM-DATA" method="POST" action="/api/product/save">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                {{--<input type="text" name="size" value="{{ old('size') }}" data-ng-model="new_product.size" class="form-control" placeholder="Size e.g S, M, L, XL" required>--}}
                                                <select name="size" value="{{ old('size') }}" data-ng-model="new_product.size" class="form-control" required>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <input type="file" accept="image/png, image/jpeg" name="image" value="{{ old('image') }}" data-ng-model="new_product.image" class="form-control" placeholder="product image" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
