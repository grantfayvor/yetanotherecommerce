...
<body class="ecommerce" data-ng-controller="CartController" data-ng-init="initialize()">
                            ...
                            <table class="table table-shopping">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button data-ng-click="submitAddress()" class="btn btn-primary" type="submit">Submit Address</button>
                                        </td>
                                        <td class="td-total">
                                            Total
                                        </td>
                                        ...
                                        <td>
                                            <a class="btn btn-info btn-fill btn-l pull-right" data-ng-disabled="cart.total_price <= 0" href="/checkout">Check Out</a>
                                        </td>
