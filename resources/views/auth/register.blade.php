        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/">
                    <i class="fa fa-chevron-left"></i> E-Commerce</a>
            </div>
            ...
            <div class="container tim-container">
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <form role="form" action="/api/user/save" id="contact-form" method="post">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <label for="name">Your name</label>
                                <input type="text" name="name" value="{{old('name')}}" class="form-control" id="name" placeholder="First Name and Last Name" />
                            </div>
                            <div class="form-group">
                                <label for="email">Email address</label>
                                <input type="email" name="email" value="{{old('email')}}" class="form-control" id="email" placeholder="Your personal email address" />
                            </div>
                            <div class="form-group">
                                <label for="phone">Phone</label>
                                <input type="text" name="phoneNumber" value="{{old('phoneNumber')}}" class="form-control" id="phone" placeholder="Phone number" />
                            </div>
                            <div class="form-group">
